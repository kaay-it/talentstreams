...
components/
  ...
  candidate-edit-modal.tsx          # Редактирование кандидата (редактор)
  candidate-section.tsx             # Группы На проверке/Активные/Отклонённые + Pencil
  employer-registration-modal.tsx
...
| Редактирование кандидата в редакторе | ✅ TASK-23 |
...
3. **TASK-27** — авто-маппинг тегов кандидата → стримы
4. **TASK-28** — автоподбор кандидатов в выпуск
5. **TASK-12** — summary кандидата в теле email-рассылки
